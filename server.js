...
app.get("/scrape_wa", function(req, res) {
  ...
  app.get("/parks_wa", function(req, res) {
    ...
    app.get("/parks_or/:id", function(req, res) {
      // Using the id passed in the id parameter, prepare a query that finds the matching one in our db...
      db.Parks_or.findOne({ _id: req.params.id })
  ...
  app.post("/Parks_or/:id", function(req, res) {
    ...
    db.Note.create(req.body)
      .then(function(dbNote) {
        ...
        return db.Parks_or.findOneAndUpdate({ _id: req.params.id }, { note: dbNote._id }, { new: true });
      })
      .then(function(dbParks_or) {
